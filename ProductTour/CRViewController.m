...
- (void)viewDidLoad
{
    ...
    CRBubble *bubbleNavBarButton = [[CRBubble alloc] initWithBar:self.navigationController.navigationBar buttonPosition:1 title:@"" description:@"TEST TEST TEST" arrowPosition:CRArrowPositionTop andColor:nil];
    
    CRBubble *bubbleTabBarButton = [[CRBubble alloc] initWithBar:self.tabBarController.tabBar buttonPosition:0 title:@"" description:@"TEST TEST TEST" arrowPosition:CRArrowPositionBottom andColor:nil];
    
    CRBubble *bubbleTabBarButton2 = [[CRBubble alloc] initWithBar:self.tabBarController.tabBar buttonPosition:1 title:@"" description:@"TEST TEST TEST" arrowPosition:CRArrowPositionBottom andColor:nil];
